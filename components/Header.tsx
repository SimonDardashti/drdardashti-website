...
const navLinks = [
  ...
  { href: "/contact", label: "Retain Dr. Dardashti" },
];
...
export default function Header() {
  ...
  return (
    <header className="bg-[#0a0a0a] text-white sticky top-0 z-50 border-b border-[#2a2a2a]">
      {/* Top bar: phone */}
      <div className="hidden md:flex justify-end max-w-6xl mx-auto px-6 py-1.5 border-b border-[#1a1a1a]">
        <a
          href="tel:+18187307579"
          className="text-xs text-[#c8a020] font-semibold tracking-widest uppercase hover:text-[#e0b830] transition-colors"
        >
          (818) 730-7579 — Available for New Engagements
        </a>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="md:hidden flex items-center gap-4">
          <a href="tel:+18187307579" className="text-[#c8a020] text-xs font-semibold">
            (818) 730-7579
          </a>
          <button
