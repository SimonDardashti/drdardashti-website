...
export const metadata: Metadata = {
  title: { absolute: "Radiculopatía Cervical | Simon Dardashti, MD" },
  description:
    "Información educativa en español sobre radiculopatía cervical y síntomas de dolor que se irradia hacia el brazo.",
  alternates: { canonical: PAGE_URL },
  openGraph: {
    type: "website",
    url: PAGE_URL,
    title: "Radiculopatía Cervical | Simon Dardashti, MD",
    description:
      "Información educativa en español sobre radiculopatía cervical y síntomas de dolor que se irradia hacia el brazo.",
...
const pageSchema = {
  ...
  "@type": "MedicalWebPage",
  name: "Radiculopatía Cervical | Simon Dardashti, MD",
  url: PAGE_URL,
  description:
    "Información educativa en español sobre radiculopatía cervical y síntomas de dolor que se irradia hacia el brazo.",
  inLanguage: "es",
  ...
  about: { "@type": "MedicalCondition", name: "Radiculopatía Cervical" },
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Radiculopatía Cervical", item: PAGE_URL },
    ],
  },
};
...
const inBrief = [
  {
    ...
    body: "La radiculopatía cervical se refiere a síntomas que pueden surgir cuando una raíz nerviosa cervical se irrita o comprime, a menudo causando dolor que se irradia hacia el brazo.",
  },
  {
    heading: "Diagnóstico preciso",
    body: "El dolor de brazo tiene múltiples posibles causas. Una evaluación clínica precisa es importante para identificar la probable raíz nerviosa afectada antes de considerar el tratamiento.",
  },
  {
...
export default function RadiculopatiaaCervicalPage() {
  return (
    <>
      ...
      <section className="bg-[#0a0a0a] text-white py-20 px-6 border-b border-[#1a1a1a]">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight" style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}>
            Radiculopatía
            <br />
            <em className="not-italic text-[#888]">Cervical.</em>
          </h1>
          <p className="mt-5 text-[#666] text-lg max-w-2xl leading-relaxed">
            La radiculopatía cervical se refiere a síntomas que pueden surgir cuando una raíz nerviosa de la columna cervical se irrita o se comprime, a menudo causando dolor que se irradia hacia el brazo o la mano. El Dr. Dardashti evalúa estas condiciones a través de un historial cuidadoso, examen neurológico y revisión de estudios de imagen cuando están disponibles.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#f9f7f4] py-20 px-6 border-b border-[#e5e5e0]">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-10 space-y-4 text-[#555] text-base leading-relaxed">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0a0a0a] mb-4" style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}>¿Qué es la radiculopatía cervical?</h2>
            <p>
              La radiculopatía cervical se refiere a disfunción o síntomas que resultan de irritación o compresión de una raíz nerviosa en la columna cervical. El término se usa para describir síntomas que pueden incluir dolor, entumecimiento, hormigueo o debilidad que viaja a lo largo de la trayectoria de un nervio cervical, típicamente hacia el brazo, antebrazo, mano o dedos.
            </p>
            <p>
              Las causas subyacentes comunes pueden incluir hernias discales cervicales, estenosis espinal cervical, estrechamiento foraminal u otras condiciones que afecten al nervio cuando sale de la columna cervical. Un diagnóstico preciso es importante porque el tratamiento depende de identificar la probable fuente del síntoma.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-10">
            ...
            <p className="text-[#666] text-base leading-relaxed mb-6 max-w-2xl">
              Los síntomas asociados con radiculopatía cervical pueden incluir:
            </p>
            <ul className="space-y-3 max-w-2xl">
              {[
                "Dolor que se irradia desde el cuello hacia el brazo, antebrazo, mano o dedos",
                "Entumecimiento u hormigueo a lo largo del brazo, mano o dedos",
                "Debilidad en el brazo, mano o dedos",
                "Dolor que empeora con ciertas posiciones del cuello o movimientos",
                "Dolor similar a una descarga eléctrica a lo largo de la distribución de un nervio",
                "Síntomas que son más intensos en un brazo que en el otro",
              ].map((item) => (
      ...
      <section className="bg-[#f9f7f4] py-20 px-6 border-b border-[#e5e5e0]">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-10 space-y-4 text-[#555] text-base leading-relaxed">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0a0a0a] mb-4" style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}>Cómo evalúa el Dr. Dardashti la radiculopatía cervical.</h2>
            <p>
              La evaluación incluye un historial detallado del inicio de los síntomas, características, distribución y respuesta al tratamiento previo. Un examen neurológico evalúa los reflejos, la sensibilidad y la fuerza muscular para ayudar a localizar la probable raíz nerviosa cervical afectada.
            </p>
            <p>
              Cuando hay disponible imágenes médicas, como resonancia magnética de la columna cervical, los hallazgos se revisan en el contexto de la presentación clínica del paciente. Una hernia discal o estrechamiento foraminal en las imágenes no indica automáticamente que sea necesario un procedimiento; las decisiones de tratamiento se basan en el cuadro clínico completo.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="md:col-span-10">
            ...
            <ul className="space-y-3 max-w-2xl">
              {[
                ...
                "Inyecciones epidurales cervicales de esteroides para pacientes seleccionados con síntomas radiculares",
                "Bloqueos selectivos de raíces nerviosas cervicales para consideración diagnóstica o terapéutica",
            ...
            <p className="text-[#777] text-sm mt-6 max-w-2xl">
              No todos los pacientes con radiculopatía cervical requieren una inyección. Las recomendaciones de tratamiento se basan en la evaluación clínica individual.
            </p>
          </div>
        </div>
      </section>
