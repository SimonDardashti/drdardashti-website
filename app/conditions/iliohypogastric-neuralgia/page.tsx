...
export const metadata: Metadata = {
  title: { absolute: "Iliohypogastric Neuralgia Evaluation | Simon Dardashti, MD" },
  description:
    "Dr. Simon Dardashti evaluates iliohypogastric neuralgia, which causes burning or shooting pain in the lower abdomen and suprapubic region due to irritation or injury of the iliohypogastric nerve.",
  alternates: { canonical: PAGE_URL },
  openGraph: {
    type: "website",
    url: PAGE_URL,
    title: "Iliohypogastric Neuralgia Evaluation | Simon Dardashti, MD",
    description:
      "Dr. Simon Dardashti evaluates iliohypogastric neuralgia, which causes burning or shooting pain in the lower abdomen and suprapubic region due to irritation or injury of the iliohypogastric nerve.",
...
const pageSchema = {
  ...
  "@type": "MedicalWebPage",
  name: "Iliohypogastric Neuralgia Evaluation | Simon Dardashti, MD",
  url: PAGE_URL,
  description:
    "Dr. Simon Dardashti evaluates iliohypogastric neuralgia, which causes burning or shooting pain in the lower abdomen and suprapubic region due to irritation or injury of the iliohypogastric nerve.",
  inLanguage: "en-US",
  isPartOf: { "@type": "WebSite", url: SITE_URL },
  about: { "@type": "MedicalCondition", name: "Iliohypogastric Neuralgia" },
  ...
  breadcrumb: {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Iliohypogastric Neuralgia", item: PAGE_URL },
    ],
  },
};

export default function IliohypogastricNeuralgiaPage() {
  return (
    <>
      ...
      <section className="bg-[#0a0a0a] text-white py-20 px-6 border-b border-[#1a1a1a]">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="mt-5 text-[#666] text-lg max-w-2xl leading-relaxed">
            Iliohypogastric neuralgia causes burning, shooting, or stabbing pain in the lower
            abdomen and suprapubic region due to irritation or injury of the iliohypogastric nerve.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-[#555] text-base leading-relaxed">
                The iliohypogastric nerve originates from the lower thoracic and upper lumbar spine
                and travels through the lower abdominal wall. Injury or compression causes neuropathic
            ...
            <div>
              ...
              <p className="text-[#555] text-base leading-relaxed">
                Iliohypogastric neuralgia can develop from abdominal surgery (cesarean section, hernia
                repair), nerve entrapment, scar tissue, direct trauma, or posture-related compression.
      ...
      <section className="bg-[#f9f7f4] py-16 px-6 border-b border-[#e5e5e0]">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-10 space-y-4 text-[#555] text-base leading-relaxed">
            ...
            <p>
              Iliohypogastric neuralgia is pain caused by irritation, compression, or injury to the
              iliohypogastric nerve, a sensory nerve that originates from the thoracolumbar spine
              (T12-L1 nerve roots) and travels through the lower abdominal wall and lower abdomen.
              When this nerve is irritated or damaged, it generates neuropathic pain characterized by
              burning, sharp, or shooting sensations in the lower abdomen, suprapubic region, and
              lower flank.
            </p>
            <p>
              The iliohypogastric nerve runs through the muscles and fascia of the lower abdominal
              wall, providing sensory innervation to the skin of the lower abdomen above the inguinal
              ligament and the suprapubic region. Because of this anatomic course, the nerve is
              vulnerable to injury during lower abdominal and pelvic surgical procedures, particularly
              cesarean section, hernia repairs, and other abdominal surgeries. The nerve can also be
              irritated by scar tissue, nerve entrapment, or compression from surrounding structures.
            </p>
            <p>
              Iliohypogastric neuralgia may be acute (sudden onset from trauma or surgery) or chronic
              (persistent or recurrent pain lasting weeks to months). The condition is sometimes
              referred to as iliohypogastric nerve pain or lower abdominal neuropathy.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-16 px-6 border-b border-[#e5e5e0]">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-10 space-y-4 text-[#555] text-base leading-relaxed">
            ...
            <p>
              Iliohypogastric neuralgia presents with a variety of neuropathic pain symptoms affecting
              the lower abdomen and suprapubic region. Typical symptoms include:
            </p>
            <ul className="space-y-2 list-disc list-inside text-[#555]">
              <li>Burning or shooting pain in the lower abdomen and suprapubic region</li>
              <li>Sharp, stabbing pain in the lower abdominal wall or lower flank</li>
              <li>Pain that may radiate across the lower abdomen or to the inner thigh</li>
              <li>Numbness or decreased sensation in the lower abdominal region</li>
              <li>Tingling or pins-and-needles sensations in the lower abdomen</li>
              <li>Pain triggered or worsened by certain movements, stretching, or positions</li>
              <li>Pain exacerbated by tight waistbands, elastic, or pressure on the lower abdomen</li>
              ...
              <li>Sensory abnormalities in the distribution of the iliohypogastric nerve</li>
            </ul>
            <p>
      ...
      <section className="bg-[#f9f7f4] py-16 px-6 border-b border-[#e5e5e0]">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-10 space-y-4 text-[#555] text-base leading-relaxed">
            ...
            <p>
              Iliohypogastric neuralgia can develop from multiple causes, ranging from surgical
              procedures to chronic compression and trauma. Common contributing factors include:
            </p>
            <ul className="space-y-2 list-disc list-inside text-[#555]">
              <li>Direct surgical injury during cesarean section (C-section)</li>
              <li>Injury during hernia repair or other lower abdominal surgery</li>
              <li>Injury during hysterectomy or other pelvic surgical procedures</li>
              ...
              <li>Direct trauma to the lower abdomen from blunt injury</li>
              <li>Chronic compression from tight clothing, tight waistbands, or sitting pressure</li>
              <li>Poor posture or repetitive activity affecting the lower abdomen</li>
              <li>Inflammation or infection in the lower abdominal region</li>
            </ul>
            <p>
              Iliohypogastric nerve injury is a recognized complication of cesarean section and other
              lower abdominal and pelvic surgeries. The nerve is vulnerable to injury during these
              procedures. In many cases, the injury occurs intraoperatively but pain may not develop
      ...
      <section className="bg-white py-16 px-6 border-b border-[#e5e5e0]">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-10 space-y-4 text-[#555] text-base leading-relaxed">
            ...
            <p>
              Diagnosis of iliohypogastric neuralgia begins with a detailed clinical history, including
              any prior abdominal or pelvic surgery, the timing of pain onset, pain character and
            ...
            <p>
              ...
              lower abdomen to identify tenderness, trigger points, or scar sensitivity. The examiner
              assesses sensory changes (numbness, tingling) in the distribution of the iliohypogastric
              nerve and may reproduce pain through specific maneuvers or palpation. Testing for pain
            ...
            <p>
              <strong>Diagnostic Procedures:</strong> Ultrasound-guided iliohypogastric nerve blocks —
              ...
              block, this confirms nerve involvement and supports the diagnosis of iliohypogastric
              neuralgia.
            </p>
            <p>
      ...
      <section className="bg-[#f9f7f4] py-16 px-6 border-b border-[#e5e5e0]">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-10 space-y-4 text-[#555] text-base leading-relaxed">
            ...
            <p>
              Treatment of iliohypogastric neuralgia is individualized based on pain severity, duration,
            ...
            <p>
              ...
              on lower abdominal muscle flexibility and posture, and avoiding tight clothing or
              waistbands that may compress the nerve. Neuropathic pain medications such as gabapentin,
            ...
            <p>
              ...
              relief, procedural interventions may be considered. Ultrasound-guided iliohypogastric
              nerve blocks — injection of local anesthetic and sometimes steroid medication around the
            ...
            <p>
              <strong>Neuromodulation:</strong> In selected patients with severe, chronic iliohypogastric
      ...
      <section className="bg-white py-16 px-6 border-b border-[#e5e5e0]">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-10 space-y-4 text-[#555] text-base leading-relaxed">
            ...
            <p>
              If you are experiencing lower abdominal or suprapubic pain that follows the distribution
              of the iliohypogastric nerve, clinical evaluation can help establish the diagnosis and
              identify appropriate treatment options. Consider seeking evaluation if:
            </p>
            <ul className="space-y-2 list-disc list-inside text-[#555]">
              <li>You have burning, shooting, or stabbing pain in the lower abdomen or suprapubic region</li>
              <li>Pain develops or persists following cesarean section or other abdominal surgery</li>
              <li>You experience numbness, tingling, or sensory changes in the lower abdomen</li>
            ...
            <p>
              ...
              diagnostic testing to confirm the diagnosis of iliohypogastric neuralgia. Once confirmed,
      ...
      <section className="bg-[#0a0a0a] py-16 px-6 border-b border-[#1a1a1a]">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-10 space-y-3 text-[#888] text-sm leading-relaxed">
            ...
            <p>
              This page describes iliohypogastric neuralgia for general educational purposes. It is not
